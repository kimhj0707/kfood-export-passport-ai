            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input id="email" type="email" placeholder="user@example.com" value={emailInput} onChange={(e) => setEmailInput(e.target.value)}
                  className="w-full rounded-lg border border-card-border bg-card-sub-bg text-text-primary py-3 px-4 text-sm focus:border-primary focus:ring-0" />
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <select id="country" value={country} onChange={(e) => setCountry(e.target.value)}
                      className="block w-full rounded-lg border border-card-border bg-card-sub-bg py-3 px-4 text-text-primary focus:border-primary focus:ring-0 text-sm appearance-none cursor-pointer">
